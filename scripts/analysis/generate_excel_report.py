...
def create_glossary_sheet(writer, signal_bonus: int):
    ...
    glossary_data = [
        ...
        ['조건', '5D-500D > 1.0 AND (5D+20D)/2 > 0.5', '가중평균 > 0.8 AND 양수 기간 > 70%', '가중평균 > 0.5 AND 5D-500D < 0', ''],
        ...
        ['계산식', '(5D + 20D) / 2', '5D - 500D', '5D×3.5 + 10D×3.0 + 20D×2.5 + 50D×2.0 + 100D×1.5 + 200D×1.0 + 500D×0.5', '(5D + 10D + ... + 500D) / 7'],
